...
df = pd.read_csv("Prematurez.csv", sep=";", skip_blank_lines=False)
...
init_color = Color("#28880c")
colors = list(init_color.range_to(Color("#76e056"),len(data_label)))
...
# plt.xticks(range(len(importance_sorted)), features_sorted, rotation='vertical')
# plt.yticks
